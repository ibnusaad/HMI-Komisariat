...
?>
	...
	<video src="media/hymne.mp4" width="100%" controls></video><br><br>

	<ul class="nav nav-tab">
		<li class="active"><a href="#konten1" data-toggle="tab">Informasi Komisariat</a></li>
	</ul>
	<div class="tab-content">
		<div class="tab-pane fade in active" id="konten1">
			<ul>
				<?php	
					$Informasi = mysql_query("select * from Informasi order by id_info desc limit 5");
					while($data=mysql_fetch_array($Informasi)){
						echo "<li><img src='gambar/Informasi/$data[gambar]'><a href='?tampil=info_detail&id=$data[id_info]'>$data[judul]</a></li>";
					}
				?>
			</ul>
		</div>
...
<ul class="nav nav-tab">
        <li class="active"><a href="#konten1" data-toggle="tab">Opini Kader</a></li>
    </ul>
    <div class="tab-content">
        <div class="tab-pane fade in active" id="konten1">
            <ul>
                <?php   
                    $Informasi = mysql_query("select * from ilmu order by id_ilmu desc limit 5");
                    while($data=mysql_fetch_array($Informasi)){
                        echo "<li><img src='gambar/opini/$data[gambar]'><a href='?tampil=ilmu_detail&id=$data[id_ilmu]'>$data[judul]</a></li>";
                    }
                ?>
            </ul>
        </div>
...
<script type="text/javascript">writeCalendar()</script><br><br>
